...
.method private hasStartupActivity()Z
    .locals 11
    ...
    .local v4, flag:I
    :try_start_0
    const-string v2, "com.sc.woa"

    .local v2, activity_package:Ljava/lang/String;
    ...
    const-string v9, ".StartupActivity"
    ...
    invoke-virtual {v5, v8, v9}, Landroid/content/Intent;->resolveActivityInfo(Landroid/content/pm/PackageManager;I)Landroid/content/pm/ActivityInfo;
    ...
    const-string v9, "easy_settings_setup_wizard_isstartup"
    ...
    const-string v10, "easy_settings_setup_wizard_isstartup : "
    ...
    .end local v2           #activity_package:Ljava/lang/String;
    ...
    .restart local v2       #activity_package:Ljava/lang/String;
    .restart local v5       #intent:Landroid/content/Intent;
    :cond_0
    const-string v8, "SetupWizard"

    const-string v9, "cannot find setupwizard, ignore it!!!"

    invoke-static {v8, v9}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v6, Landroid/content/Intent;

    const-string v8, "com.sc.woa.setupkeyguard"

    invoke-direct {v6, v8}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v6, setupIntent:Landroid/content/Intent;
    iget-object v8, p0, Lcom/android/server/am/ActivityStack;->mContext:Landroid/content/Context;
    ...
    .end local v2           #activity_package:Ljava/lang/String;
    .end local v5           #intent:Landroid/content/Intent;
    .end local v6           #setupIntent:Landroid/content/Intent;
    :catch_0
    move-exception v3
    ...
    const-string v10, "hasStartupActivity : "
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->hasStartupActivity()Z
    ...
    :cond_0
    const-string v16, "com.sc.woa"

    .local v16, activity_package:Ljava/lang/String;
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    .local v15, activity_name:Ljava/lang/String;
    :try_start_0
    ...
    invoke-virtual {v2}, Lcom/android/server/am/ActivityManagerService;->startWOARegisterActivityLocked()Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual/range {v18 .. v18}, Ljava/lang/Exception;->getLocalizedMessage()Ljava/lang/String;
    ...
    .end local v15           #activity_name:Ljava/lang/String;
    .end local v16           #activity_package:Ljava/lang/String;
