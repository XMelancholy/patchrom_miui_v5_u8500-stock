...
.method private getBoolean(Ljava/lang/String;Z)Z
    ...
    .local v1, settings:Lcom/android/internal/widget/ILockSettings;
    if-eqz v1, :cond_0
    ...
    .end local v1           #settings:Lcom/android/internal/widget/ILockSettings;
    .end local p2
    :cond_0
    :goto_0
    return p2
...
.method private getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v1, p1, v3, v4}, Lcom/android/internal/widget/ILockSettings;->getString(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private setBoolean(Ljava/lang/String;Z)V
    ...
    .restart local v1       #settings:Lcom/android/internal/widget/ILockSettings;
    :cond_0
    const-string v2, "LockPatternUtils"

    const-string v3, "lock setting service is not ready"
...
.method public savedPasswordExists()Z
    ...
    invoke-interface {v3, v4}, Lcom/android/internal/widget/ILockSettings;->havePassword(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public savedPatternExists()Z
    ...
    invoke-interface {v1, v3}, Lcom/android/internal/widget/ILockSettings;->havePattern(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
