...
.method private animateInternal(IZI)V
    ...
    iget-wide v11, v0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->startTimeMillis:J
    ...
    iget-wide v11, v0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->lastTime:J
    ...
    const-string v13, "WARNING: Clock ERROR!!!!!! now-"
    ...
    const-string v13, " startTimeMillis-"
    ...
    iget-wide v13, v0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->lastTime:J
    ...
    iput-wide v11, v0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->lastTime:J
    ...
    iget v13, v0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->duration:I
    ...
    const-string v13, " Animation1: newValue-"
    ...
    const-string v13, "  --- confirm--- newValue-"
    ...
    const-string v13, " WARNING: newValue-"
    ...
    iget v12, v0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->startSensorValue:I
    ...
    invoke-virtual {v11, v12, v0, v7}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    invoke-virtual {v11, v4, v12, v13}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z

    .end local v2           #elapsed:I
    .end local v4           #msg:Landroid/os/Message;
    .end local v5           #newNow:J
    ...
    .restart local v5       #newNow:J
    .restart local v8       #now:J
    :cond_5
    move-object/from16 v0, p0

    iput-wide v5, v0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->lastTime:J
...
.method public animateTo(IIII)V
    ...
    iget-wide v3, p0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->startTimeMillis:J

    iput-wide v3, p0, Lcom/android/server/PowerManagerService$ScreenBrightnessAnimator;->lastTime:J
